...
var objectEmit_ = window.tracking.ObjectTracker.prototype.emit;
var colorEmit_ = window.tracking.ColorTracker.prototype.emit;

stats.begin();

window.tracking.ObjectTracker.prototype.emit = function() {
    stats.end();
    objectEmit_.apply(this, arguments);
};

window.tracking.ColorTracker.prototype.emit = function() {
    stats.end();
